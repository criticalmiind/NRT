...
export default class LatestAbout extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoading: true
            ...
            <ImageBackground source={require("../resources/images/bg1.png")} resizeMode="cover" style={{ flex: 1 }} resizeMode="cover">
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={{ height: '100%' }}>
                        <LatestWebView uri={"https://nrttv.com/about.aspx"} hideSpinner={this.hideSpinner} isLoading={this.state.isLoading} />
                    </View>
                    {/* <View style={{}}>
                        <LatestBottom />
                    </View> */}
