...
export default class CategoryBtn4 extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoading: true
            ...
            <ImageBackground source={require("../resources/images/bg1.png")} resizeMode="cover" style={{ flex: 1 }} resizeMode="cover">
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={{ height: '100%' }}>
                        <LatestWebView uri={"https://nrttv.com/nrt2/Babetekan.aspx?MapID=4"} hideSpinner={this.hideSpinner} isLoading={this.state.isLoading} />
                    </View>
                    {/* <View style={{}}>
                        <LatestBottom />
                    </View> */}
